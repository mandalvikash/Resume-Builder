...
export default function StepCapstone({ data, update }) {
  ...
  return (
    <section className="space-y-4">
      <h2 className="font-display text-lg font-semibold text-slate-900">Capstone project</h2>
      <div className="space-y-4 p-4 rounded-xl border border-slate-200 bg-white">
        ...
        <label className="block">
          <span className="text-sm font-medium text-slate-700">Tech stack (add one per line)</span>
        ...
        <label className="block">
          <span className="text-sm font-medium text-slate-700">Key outcomes</span>
