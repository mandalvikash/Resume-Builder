...
export default function Signup() {
  ...
  const handleGoogleSignup = () => {
    window.alert('Google sign-up will be available soon.');
  };

  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md flex flex-col items-center">
        <h1 className="font-display text-2xl font-bold text-slate-900 dark:text-white mb-2 text-center">Sign up</h1>
        <p className="text-slate-600 dark:text-slate-400 mb-6 text-center">Create an account to start building your dossier.</p>
